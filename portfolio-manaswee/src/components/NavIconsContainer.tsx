...
function NavIconsContainer() {
  return (
    <div className="flex absolute left-1/4 bg-neutral-800 w-6/12 items-center justify-around p-4 rounded-xl">
        <a className="text-2xl font-orbitron font-normal" href="#"><ShinyText text={"Home"} disabled={false} speed={5}></ShinyText></a>
