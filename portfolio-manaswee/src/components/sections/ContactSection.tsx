...
function ContactSection() {
    return (
        <div className="grid justify-center items-center w-full grid-cols-2 grid-rows-1 px-12">
            <div>
                <h3 className="w-full text-center text-4xl font-orbitron">Thanks for hanging till the end!</h3>
                <p className="w-full font-orbitron px-4 text-center">It was a pleasure hosting you. Need something to say? Say it in the form along with your email and I'll be in you Gmail...</p>
