...
const CircularText = ({
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`rounded-full w-[100px] h-[100px] text-white font-black text-center cursor-pointer origin-center ${className}`}
      animate={controls}
    ...
    >
      {letters.map((letter, i) => {
        ...
        return (
          <span
            key={i}
            className="absolute inline-block inset-0 text-md md:text-xs transition-all duration-500 ease-[cubic-bezier(0,0,0,1)]"
