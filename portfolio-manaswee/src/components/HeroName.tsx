  ...
  return (
    <div className="cursor-default flex mb-36 items-center justify-center flex-col md:flex-row">
        <div className="relative w-[100vw] h-[60vh] md:h-[120vh] md:w-[40vw] overflow-y-scroll">
            <div className="absolute inset-0 bg-background-dark/70 flex items-center justify-center flex-col">
                ...
                <div className="px-12 md:px-8">
                    ...
                    <p className="mt-4 text-scheme-white text-4xl font-orbitron">I'm <span className="text-primary">Manaswee Chauhan</span></p>
                    <p className="mt-4 text-scheme-white text-3xl font-orbitron">I have a passion for learning and love for the world of Logics and Pixels. I'm currently enrolled as a B.Tech student in branch CSE.</p>
                    <p className="mt-4 text-scheme-white text-3xl font-orbitron">This is my journey. <span className="text-primary">Hop in</span></p>
                </div>
            </div>
        </div>
