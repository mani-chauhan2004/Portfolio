...
function HeroName() {
  return (
    <div className="cursor-default flex items-center justify-center flex-col md:flex-row">
        <div className="relative w-[100vw] h-[100vh] md:h-[120vh] md:w-[40vw]">
        ...
        <div className=' flex relative w-[100vw] h-[120vh] items-center gap-38 flex-col p-12 bg-[url("/IMG/hero_image.png")] bg-right bg-contain bg-no-repeat md:bg-cover md:bg-top md:w-[60vw]' id="Home">
